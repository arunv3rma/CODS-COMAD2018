...
def regret_plotting(regret, classifier_count, data_points):
    ...
    plt.savefig("output/final_plot/svm_" + str(data_points) + ".png", bbox_inches='tight')
    plt.close()


# Reading Data
# data_plot = [10000, 25000, 50000, 100000]
data_plot = [25000, 100000]
...
for d in range(len(data_plot)):
    ...
    for c in classifiers_count:
        fileName = "output/regretFiles/5d_SVM/" + str(data_plot[d]) + "_" + str(c) + ".txt"
